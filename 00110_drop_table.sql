...
drop table if exists direcciones_proveedores        cascade;
...
drop table if exists tipos_cuentas_bancarias        cascade;
drop table if exists bancos                         cascade;
drop table if exists cuentas_bancarias_proveedores  cascade;
...
drop table if exists tipos_asientos_contables       cascade;
drop table if exists origenes_asientos_contables    cascade;
