...
create or replace view dipr as select * from direcciones_proveedores;
...
create or replace view ticb as select * from tipos_cuentas_bancarias;
create or replace view banc as select * from bancos;
create or replace view cubp as select * from cuentas_bancarias_proveedores;
...
create or replace view comp as select * from compras;
create or replace view deco as select * from detalles_compras;
...
create or replace view orac as select * from origenes_asientos_contables;
