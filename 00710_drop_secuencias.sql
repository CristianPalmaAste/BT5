...
drop sequence if exists dipr_seq;
...
drop sequence if exists ticb_seq;
drop sequence if exists banc_seq;
drop sequence if exists cubp_seq;
...
drop sequence if exists deco_seq;
...
drop sequence if exists orac_seq;
