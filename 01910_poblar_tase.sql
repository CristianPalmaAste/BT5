...
insert into tablas_secuencias values ('estados_requisiciones'           , 'ereq_seq');
insert into tablas_secuencias values ('tipos_requisiciones'             , 'tire_seq');
insert into tablas_secuencias values ('requisiciones'                   , 'requ_seq');
insert into tablas_secuencias values ('detalles_requisiciones'          , 'dere_seq');
insert into tablas_secuencias values ('autorizadores_requisiciones'     , 'aure_seq');
insert into tablas_secuencias values ('historiales_requisiciones'       , 'hire_seq');
insert into tablas_secuencias values ('estados_ordenes_compras'         , 'esoc_seq');
insert into tablas_secuencias values ('estados_detalles_ordenes_compras', 'edoc_seq');
insert into tablas_secuencias values ('ordenes_compras'                 , 'orco_seq');
insert into tablas_secuencias values ('detalles_ordenes_compras'        , 'deoc_seq');
insert into tablas_secuencias values ('cotizaciones_compras'            , 'coco_seq');
insert into tablas_secuencias values ('detalles_cotizaciones_compras'   , 'decc_seq');
insert into tablas_secuencias values ('proveedores'                     , 'prov_seq');
