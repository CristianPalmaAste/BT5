...
begin
  ...
  ;
  if Vcatalog_name in ('test1', 'test3') then
    select nextval('pers_seq') into Vidpers;
    --
  ...
  insert into servicios values (nextval('serv_seq'), 1 , 1 , 1, 'CONSULTOR JUNIOR'    , 0.5   , 12, Vidcuco, 1, current_timestamp, null, null, null, null);
  insert into servicios values (nextval('serv_seq'), 1 , 1 , 1, 'CONSULTOR SENIOR'    , 1     , 12, Vidcuco, 1, current_timestamp, null, null, null, null);
  insert into servicios values (nextval('serv_seq'), 1 , 1 , 1, 'JEFE DE PROYECTO'    , 1.5   , 12, Vidcuco, 1, current_timestamp, null, null, null, null);
  insert into servicios values (nextval('serv_seq'), 1 , 1 , 1, 'GERENTE DE PROYECTO' , 3     , 12, Vidcuco, 1, current_timestamp, null, null, null, null);
  insert into servicios values (nextval('serv_seq'), 1 , 2 , 1, 'ASEO'                , 5000  , 1 , Vidcuco, 1, current_timestamp, null, null, null, null);
  insert into servicios values (nextval('serv_seq'), 1 , 2 , 1, 'GUARDIA DE SEGURIDAD', 10000 , 1 , Vidcuco, 1, current_timestamp, null, null, null, null);
...
begin
  ...
  insert into cotizaciones_ventas values (Vidcove                    -- id                       numeric(20,0)   not null
                                         ,1                          -- idempr                   numeric(20,0)   not null
                                         ,1                          -- idbode                   numeric(20,0)   not null
                                         ,2                          -- numero                   numeric(20,0)   not null
                                         ,1                          -- idclie                   numeric(20,0)   not null
                                         ,'PRUEBA 2'                 -- descripcioncotizacion    varchar(1000)   not null
                                         ,current_timestamp          -- fechacotizacion          timestamp       not null
                                         ,null                       -- idgere                   numeric(20,0)       null
                                         ,null                       -- idproy                   numeric(20,0)       null
                                         ,null                       -- idline                   numeric(20,0)       null
                                         ...
                                         ,null                       -- idtare                   numeric(20,0)       null
                                         ,0                          -- exento                   numeric(20,0)   not null
                                         ,6000                       -- afecto                   numeric(20,0)   not null
                                         ,1140                       -- impuestosobligats        numeric(20,0)   not null
                                         ,0                          -- impuestosespecifs        numeric(20,0)   not null
                                         ,0                          -- porcentajedescuento      numeric(20,2)   not null
                                         ,0                          -- montodescuento           numeric(20,2)   not null
                                         ,7140                       -- total                    numeric(20,0)   not null
                                         ,5                          -- diasvalidez              numeric(20,0)   not null
                                         ,1                          -- idescv                   numeric(20,0)   not null
                                         ,3                          -- idusuavendedor           numeric(20,0)   not null
                                         ,1                          -- idusuacrearegistro       numeric(20,0)   not null
  ...
  insert into detalles_cotizs_vtas values (nextval('decv_seq')                       -- id                       numeric(20,0)   not null
                                          ,Vidcove                                   -- idcove                   numeric(20,0)   not null
                                          ,1                                         -- correlativo              numeric(20,0)   not null
                                          ,13                                        -- idprod                   numeric(20,0)       null
                                          ,null                                      -- idserv                   numeric(20,0)       null
                                          ,1000                                      -- preciounitario           numeric(20,0)   not null
                                          ,2                                         -- cantidad                 numeric(20,2)   not null
                                          ,0                                         -- porcentajedescuento      numeric(20,2)   not null
                                          ,0                                         -- montodescuento           numeric(20,2)   not null
                                          ,0                                         -- exento                   numeric(20,0)   not null
  ...
  insert into detalles_cotizs_vtas values (nextval('decv_seq')                       -- id                       numeric(20,0)   not null 
                                          ,Vidcove                                   -- idcove                   numeric(20,0)   not null
                                          ,2                                         -- correlativo              numeric(20,0)   not null
                                          ,17                                        -- idprod                   numeric(20,0)       null
                                          ,null                                      -- idserv                   numeric(20,0)       null
                                          ,4000                                      -- preciounitario           numeric(20,0)   not null
                                          ,1                                         -- cantidad                 numeric(20,2)   not null
                                          ,0                                         -- porcentajedescuento      numeric(20,2)   not null
                                          ,0                                         -- montodescuento           numeric(20,2)   not null
                                          ,0                                         -- exento                   numeric(20,0)   not null
                                          ,4000                                      -- afecto                   numeric(20,0)   not null
                                          ,760                                       -- impuestosobligats        numeric(20,2)   not null
                                          ,0                                         -- impuestosespecifs        numeric(20,2)   not null
                                          ,4760                                      -- totallinea               numeric(20,2)   not null
                                          ,1                                         -- idusuacrearegistro       numeric(20,0)   not null
                                          ,current_timestamp                         -- fechacrearegistro        timestamp       not null
                                          ,null                                      -- idusuamodifregistro      numeric(20,0)       null
                                          ,null                                      -- fechamodifregistro       timestamp           null
...
insert into detalles_requisiciones values (2, 1, 2, 2   , null, null              , 20, 500, 1, current_timestamp, null, null, null, null);
insert into detalles_requisiciones values (3, 1, 3, 3   , null, null              , 30, 300, 1, current_timestamp, null, null, null, null);
insert into detalles_requisiciones values (4, 1, 4, null, 1   , null              , 1 ,  50, 1, current_timestamp, null, null, null, null);
insert into detalles_requisiciones values (5, 1, 5, null, null, 'GALLETAS COMPETA', 1 , 200, 1, current_timestamp, null, null, null, null);
...
insert into detalles_requisiciones values (6 , 2, 1, 13  , null, null            , 5 , 300, 1, current_timestamp, null, null, null, null);
insert into detalles_requisiciones values (7 , 2, 2, 14  , null, null            , 5 , 200, 1, current_timestamp, null, null, null, null);
insert into detalles_requisiciones values (8 , 2, 3, 15  , null, null            , 10, 400, 1, current_timestamp, null, null, null, null);
insert into detalles_requisiciones values (9 , 2, 4, null, 2   , null            , 1 ,  50, 1, current_timestamp, null, null, null, null);
insert into detalles_requisiciones values (10, 2, 5, null, null, 'GOMA DE BORRAR', 10, 200, 1, current_timestamp, null, null, null, null);
...
insert into compras values (1, 1, 1, 1, 1, 2, 1, current_timestamp, current_timestamp, 5000, 0, 950, 5950, null, 1, current_timestamp, null, null, null, null);
...
insert into detalles_compras values (3, 1, 3, 3, null, null, 5, 500, 1, current_timestamp, null, null, null, null);
...
insert into compras values (2, 1, 2, 1, 1, 2, 2, current_timestamp, current_timestamp, 2700, 0, 513, 3213, null, 1, current_timestamp, null, null, null, null);
...
insert into detalles_compras values (6, 2, 3, 3, null, null, 3, 100, 1, current_timestamp, null, null, null, null);
...
insert into usuarios_perfiles values (nextval('uspe_seq'), 10, 13, null, 1, 1, 1, current_timestamp, null, null, null, null);
